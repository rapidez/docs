...
In this release, we migrated from Vue 2 to Vue 3 and we've also removed the need for flat tables to be enabled 🚀

Both of these are quite substantially breaking changes. On this page we'll mention the most important things that you will need to do to upgrade.
...
Some recurring themes we've run into:
